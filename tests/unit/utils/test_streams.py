...
from amundsen_common.utils.streams import (PeekingIterator, _assure_collection,
                                           async_consume_in_chunks,
                                           consume_in_chunks,
                                           consume_in_chunks_with_state,
                                           one_chunk, reduce_in_chunks)
...
class TestConsumer(unittest.TestCase):
    ...
    def test_one_chunk_logging(self) -> None:
        ...
        with self.assertLogs(logger='amundsen_common.utils.streams', level=logging.ERROR):
            actual, has_more = one_chunk(it=it, n=2, metric=lambda x: x)
